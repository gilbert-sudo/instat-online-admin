...
<html>
  ...
  <body class="skin-blue">
    <?php include'../php/edit_event.php'; ?>
...
<header class="main-header">
    ...
    if (isset($_GET['id_event'])) {
      ...
      $showevent = $bdd->prepare("SELECT * FROM ad_event WHERE id_event = ?");
  ...
  ?>
                    <div class="form-group">
                      <label>Titre :</label>
                      <input type="text" class="form-control" name="newtitle" value="<?=$editevent['titre_event'];?>">
                    </div>
                    <div class="form-group">
                      <label>Date :</label>
                        
                      <input type="date" class="form-control" name="newdate" style="width: 100px;" value="<?=$editevent['date_event'];?>">
                      <div class="form-group">
                      <label>Heure :</label>
                      <input type="time" class="form-control"  name="newtime" style="width: 100px;" value="<?=$editevent['time_event'];?>">
                       
                      </div>
                    </div>
                    <div class="form-group">
                    <label>Description :</label>
                     <textarea class="form-control" rows="3" name="newdescription" ><?=$editevent['description_event'];?></textarea>
                   </div>
                </div>

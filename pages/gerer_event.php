...
<html>
  ...
  <body class="skin-blue">
    ...
    $reqevent = $bdd->prepare("SELECT * FROM ad_event");
    $reqevent->execute();
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Gérer les événements</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?= $afevent['titre_event']; ?></td>
                        <td><?= $afevent['date_event']; ?><br><?= $afevent['time_event']; ?></td>
                        <td><?= $afevent['description_event']; ?></td>
                        <td><img style="width: 140px; height: 120px;" src="../images/Evenement/<?= $afevent['image']; ?>" ></td>
                        <td><div style="margin-top: 16px;"><a class="btn btn-block btn-danger" href="../php/del_event.php?id_event=<?= $afevent['id_event']; ?>"><i class="glyphicon glyphicon-trash"></i></a><br>
                          <a class="btn btn-block btn-primary" href="edit_event.php?id_event=<?= $afevent['id_event']; ?>"><i class="fa fa-edit"></i></a></div></td>
                      </tr>
